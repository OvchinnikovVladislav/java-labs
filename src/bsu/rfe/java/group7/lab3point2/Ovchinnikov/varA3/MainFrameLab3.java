package bsu.rfe.java.group7.lab3point2.Ovchinnikov.varA3;
...
public class MainFrameLab3 extends JFrame {
...
// манипулировать из разных мест
    ...
    public MainFrameLab3(Double[] coefficients) {
...
// Показать диалоговое окно
                if (fileChooser.showSaveDialog(MainFrameLab3.this) ==
...
// Запросить пользователя ввести искомую строку
                String value =
                        JOptionPane.showInputDialog(MainFrameLab3.this, "Введите значение для поиска",
...
// По умолчанию пункт меню является недоступным (данных ещѐ нет)
        ...
        aboutMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(MainFrameLab3.this, "Автор: Овчинников Владислав; Группа: 7");
            }
        });
        refMenu.add(aboutMenuItem);
...
// На основе считанных данных создать новый экземпляр модели таблицы
                    data = new GornerTableModel(from, to, step, MainFrameLab3.this.coefficients);
...
// В случае ошибки преобразования чисел показать сообщение об ошибке
                    JOptionPane.showMessageDialog(MainFrameLab3.this,
...
// Создать экземпляр главного окна, передав ему коэффициенты
        MainFrameLab3 frame = new MainFrameLab3(coefficients);
